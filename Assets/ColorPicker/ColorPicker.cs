...
public class ColorPicker : MonoBehaviour
{
    ...
    public void _DrawGUI()
    {
        ...
        Rect rectColorSlider = new Rect(startPos.x + sizeCurr + 50, startPos.y + 30, 120, 140);
      ...
      //  GUI.Label(new Rect(startPos.x + sizeCurr + 60, startPos.y, 200, 30), Title, titleStyle);
        ...
        /*
                ...
                {
                    txtR = GUI.TextField(new Rect(startPos.x + sizeCurr + 40, startPos.y + 30, 40, 20), txtR, 3);
                    txtG = GUI.TextField(new Rect(startPos.x + sizeCurr + 40, startPos.y + 90, 40, 20), txtG, 3);
                    txtB = GUI.TextField(new Rect(startPos.x + sizeCurr + 40, startPos.y + 150, 40, 20), txtB, 3);
                  //  txtA = GUI.TextField(new Rect(startPos.x + sizeCurr + 40, startPos.y + 210, 40, 20), txtA, 3);
                    valR = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 100, startPos.y + 35, 120, 40), valR, 0.0f, 1.0f);
                    valG = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 100, startPos.y + 95, 120, 20), valG, 0.0f, 1.0f);
                    valB = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 100, startPos.y + 155, 120, 20), valB, 0.0f, 1.0f);
                   // valA = GUI.HorizontalSlider(new Rect(startPos.x + sizeCurr + 100, startPos.y + 215, 120, 20), valA, 0.0f, 1.0f);
                    if (GUI.Button(new Rect(startPos.x + sizeCurr + 40, startPos.y + 400, 100, 40), "Apply"))
                    {
                        ApplyColor();
        ...
        */
        ...
        //draw color picker
        Rect rect = new Rect(Screen.width/2 - sizeCurr/2, Screen.height / 2 - sizeCurr / 2, sizeCurr, sizeCurr);
        GUI.DrawTexture(rect, colorSpace);
        startPos = new Vector2(Screen.width / 2 - sizeCurr / 2, Screen.height / 2 - sizeCurr / 2);
    ...
    public void ApplyColor()
    {
        ...
        {
            receiver.SendMessage(colorSetFunctionName, SelectedColor, SendMessageOptions.DontRequireReceiver);
            //Application.OpenURL("http://192.168.1.5/?r235g145/b115&#");
            StartCoroutine(GetRequest("http://192.168.1.5/?r" + txtR + 'g' + txtG + 'b' + txtB + '&'));



            //235g145b115 & dsfsdfas
            Debug.Log(txtR);
            Debug.Log(txtG);
            Debug.Log(txtB);
